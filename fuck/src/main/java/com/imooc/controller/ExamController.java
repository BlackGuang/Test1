...
//    public int getScore(@RequestParam("userAnswer[]") int[] userAnswer,
//                        HttpServletRequest request, HttpServletResponse response){
//        response.setHeader("Access-Control-Allow-Origin", "*");
//        int testID=1;
//        int userScore=0;
...
//
//            System.out.println("用户答案"+userAnswer[i]);
//            System.out.println("正确答案"+exams.get(i).getAnswer());
//            if(userAnswer[i]==exams.get(i).getAnswer()){
...
//            System.out.println("题目"+exams.get(i).getContext());
//
//            System.out.println("用户答案"+meUserAnswer[i]);
//            System.out.println("正确答案"+exams.get(i).getAnswer());
//            if(meUserAnswer[i]==exams.get(i).getAnswer()){
//                userScore=userScore+10;
//            }
//        }
       String userAnswer="#1#";
